...
########################################################################
### by: Ana Flávia Augustin in 2025 - Myrceugenia bsicordata 
...
### Occurrences data
occ <- read.delim(file.path(coord_path, "occ_basicordata_2.txt"))
...
write.xlsx(model_eval, file = file.path(coord_path, "Maxent_perf_basi.xlsx"))
...
writeRaster(raster_continuo, "pres_cont_basi.tif", overwrite = TRUE)
writeRaster(raster_binario, "pres_bin_basi.tif", overwrite = TRUE)
...
writeRaster(raster_continuo, "scenario1_cont_basi.tif", overwrite = TRUE)
writeRaster(raster_binario, "scenario1_bin_basi.tif", overwrite = TRUE)
...
writeRaster(raster_continuo, "scenario2_cont_basi.tif", overwrite = TRUE)
writeRaster(raster_binario, "scenario2_bin_basi.tif", overwrite = TRUE)
...
writeRaster(raster_continuo, "scenario3_cont_basi.tif", overwrite = TRUE)
writeRaster(raster_binario, "scenario3_bin_basi.tif", overwrite = TRUE)
...
writeRaster(raster_continuo, "scenario4_cont_basi.tif", overwrite = TRUE)
writeRaster(raster_binario, "scenario4_bin_basi.tif", overwrite = TRUE)
